...
In this reverse engineering challenge, we need to figure out what kind of input a program needs to print "SUCCESS". We're given a decompiled C++ file, and by analyzing it step by step, we can crack the puzzle.
